...
public class NightreignConverter : Converter
{
    ...
    public override void DoConversion()
    {
        ...
        if (ConversionContext.CurrentTextureSourceFileName.Contains("anibnd") && ConversionContext.SourceBndsType == ConversionContext.AssetType.Character)
        {
            ...
            if (Array.IndexOf(anibndNames, ConversionContext.CurrentTextureSourceFileName) == anibndNames.Length - 1)
            {
        ...
        else if (ConversionContext.CurrentTextureSourceFileName.Contains("geombnd") && ConversionContext.SourceBndsType == ConversionContext.AssetType.Object)
        {
        ...
        else if (ConversionContext.CurrentTextureSourceFileName.Contains("geomhkxbnd") && ConversionContext.SourceBndsType == ConversionContext.AssetType.Object)
        {
    ...
    private void WriteCombinedObjbnd()
    {
        ...
        if (Array.IndexOf(geombndNames, ConversionContext.CurrentTextureSourceFileName) == geombndNames.Length - 1)
        {
    ...
    {
        if (ConversionContext.CurrentTextureSourceFileName.Contains("geombnd"))
        {
        ...
        foreach (BinderFile hkx in newBnd.Files)
        {
            ...
            if (ConversionContext.CurrentTextureSourceFileName.Contains("_c", StringComparison.OrdinalIgnoreCase))
            {
                hkx.Name = $"{path}o{ConversionContext.PortedId}_c.hkx";
            }
            else if (ConversionContext.CurrentTextureSourceFileName.Contains("geomhkxbnd"))
            {
